...
if weather_repo < 18:
    weather_body = "*weather* for today in Netanya is : {0} Degrees  Wear something hot".format(
        weather_repo
    )

else:
    weather_body = "*The* Weather For today In Netanya is : {0} Degrees Wear Gufiya".format(
        weather_repo
    )
